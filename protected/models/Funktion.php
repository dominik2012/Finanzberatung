...
class Funktion extends CActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			...
			'priv_mit_beratung' => 'Priv Mit Beratung',
			'priv_ohne_beratung' => 'Priv Ohne Beratung',
			'prof_mit_beratung' => 'Prof Mit Beratung',
			'prof_ohne_beratung' => 'Prof Ohne Beratung',
			'hinweis' => 'Hinweis',
			'weiterereg' => 'Weiterereg',
			'hsr_aktuell' => 'Hsr Aktuell',
			'hsr_zukuenftig' => 'Hsr Zukuenftig',
			'r_ausf_geschaeft' => 'R Ausf Geschaeft',
